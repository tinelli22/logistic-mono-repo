...
import type { JSX } from 'webcomponents';



export const LogButton = /*@__PURE__*/createReactComponent<JSX.LogButton, HTMLLogButtonElement>('log-button');
export const LogCard = /*@__PURE__*/createReactComponent<JSX.LogCard, HTMLLogCardElement>('log-card');
